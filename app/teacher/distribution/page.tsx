...
export default function DistributionPage() {
  ...
  return (
    <main className="shell">
      ...
      <section className="section"><div className="notice">«الإملاء والخط» مادة واحدة معتمدة في النظام، وتبقى مرتبطة بتوزيعها ومهارات الإملاء والخط معًا.</div></section>
    </main>
  );
}
