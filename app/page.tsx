...
export default function TeacherHome(){
 ...
 return <main className="ta-app ta-teacher-home">
  ...
  <section className="ta-action-grid"><Link href="/teacher/students"><Image src="/teacher-icons/students.svg" alt="" width={58} height={58}/><div><b>الطلاب</b><span>افتح التقييم الشامل بالاسم</span></div></Link><Link href="/teacher/students"><Image src="/guardian-icons/trophy.svg" alt="" width={58} height={58}/><div><b>التقييم الشامل</b><span>المواد · السلوك · القيم · المتابعة</span></div></Link><Link href="/teacher/library"><Image src="/guardian-icons/library.svg" alt="" width={58} height={58}/><div><b>المكتبة</b><span>ملفات خاصة وعامة</span></div></Link><Link href="/teacher/announcements"><Image src="/guardian-icons/message.svg" alt="" width={58} height={58}/><div><b>التواصل</b><span>الإعلانات وطلبات التواصل</span></div></Link></section>
