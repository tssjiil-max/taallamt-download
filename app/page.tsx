  ...
  return (
    <main className="shell">
      ...
      <section className="grid">
        ...
        <Link className="card" href="/teacher/assessment"><div className="icon green">✅</div><h3>سجل متابعة المهارات</h3><p>تقييم مهارات القرآن ولغتي والدراسات الإسلامية طالبًا طالبًا مع حفظ التاريخ.</p></Link>
        <Link className="card" href="/teacher/resources"><div className="icon amber">📝</div><h3>أوراق العمل والاختبارات</h3><p>توليد ورقة عمل أو تدريب مهارات أو اختبار نصفي/نهائي ثم الطباعة أو الإرسال لولي الأمر.</p></Link>
