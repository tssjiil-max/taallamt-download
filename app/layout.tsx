...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="ar" dir="rtl"><body><TaallamtProvider>{children}</TaallamtProvider></body></html>; }
