...
ensureImg(student.querySelector('.studentProfileMain'),'.studentMainLogo','studentMainLogo',SHAKABUMBO_MAIN,'شكابمبو');
ensureImg(student.querySelector('.profileAvatarWrap'),'.studentProfileAvatar','studentProfileAvatar',SHAKABUMBO_PROFILE,'صورتي');
const starToday=student.querySelector('.starToday');if(starToday){starToday.querySelector('.starIcon')?.remove();ensureImg(starToday,'.studentStarMascot','studentStarMascot',SHAKABUMBO_STAR,'نجم اليوم')}
